...
sys.taskInit(function()
    ...
    log.debug("START_Time_CHX_CONFIG     ------------",fskv.get("START_Time_CHX_CONFIG")["_1"],fskv.get("START_Time_CHX_CONFIG")["_2"],fskv.get("START_Time_CHX_CONFIG")["_3"],fskv.get("START_Time_CHX_CONFIG")["_4"])
    log.debug("CLOSE_Time_CHX_CONFIG     ------------",fskv.get("CLOSE_Time_CHX_CONFIG")["_1"],fskv.get("CLOSE_Time_CHX_CONFIG")["_2"],fskv.get("CLOSE_Time_CHX_CONFIG")["_3"],fskv.get("CLOSE_Time_CHX_CONFIG")["_4"])
    log.debug("Time_ENABLE_CHX_CONFIG    ------------",fskv.get("Time_ENABLE_CHX_CONFIG")["_1"],fskv.get("Time_ENABLE_CHX_CONFIG")["_2"],fskv.get("Time_ENABLE_CHX_CONFIG")["_3"],fskv.get("Time_ENABLE_CHX_CONFIG")["_4"])
    log.info("POWER_CLOSE_ENABLE_CONFIG ------------",fskv.get("POWER_CLOSE_ENABLE_CONFIG"))
    log.info("ElE_CHX                   ------------",fskv.get("ElE_CHX")["_1"],fskv.get("ElE_CHX")["_2"],fskv.get("ElE_CHX")["_3"],fskv.get("ElE_CHX")["_4"])
